...
3. MSRP depreciation story — Hendrick Affordable units often carry very large MSRP-to-current-price gaps given their age and mileage. When original MSRP data is available, always include the depreciation story; do not skip it in favor of a lesser selling angle.
